  ...
  <v-container>
    ...
    <div 
      ...
      <v-layout 
        ...
        <v-flex 
          class="grey--text text--darken-1 title ml-5" 
          sm4>
    ...
    <v-layout 
      ...
      wrap>
      <v-btn 
        class="align-center-keepShopping" 
        color="primary" 
        to="/services/rentals">Keep Shopping</v-btn>
    </v-layout>
    <v-layout 
      v-if="cartTotal != 0" 
      row 
      ...
      <v-flex 
        ...
        <p class="body-text">At this point in time we do not accept online payment.
        Please fill out the form below and a request for your cart items will be sent to Hi Light. 
        We will work to approve your request quickly and contact you about delivery and payment. Thank you for your business and stay Lit!</p>
        <!-- <v-form 
          ref="form" 
    ...
    <v-snackbar 
      :timeout="3000"
      v-model="snackbar">{{ responseMessage }}</v-snackbar>
      <!-- <v-layout 
      justify-center 
      row 
      wrap>
